...
public class UserEntity {
    ...
    @OneToOne(mappedBy = "user", cascade = CascadeType.ALL) //cho nay thi phai dung ten cua Entity
    @PrimaryKeyJoinColumn //tham khao them tu bai cua nguoi khac
    private UserDetailEntity userDetailEntity; //trả về 1 doi tuong do OneToOne

    @JsonIgnore
    @OneToMany(mappedBy= "userEntity") //thay ten cua Entity "restaurant" bang doi tuong cua Class
